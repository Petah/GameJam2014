...
public class UIOverlay : MonoBehaviour {
    ...
    */
    ...
    public void OnGUI() {
		...
		GUI.DrawTexture(new Rect(90, 798, 54, 52), item);
		GUI.DrawTexture(new Rect(135, 800, 26, 28), kill);
		//GUI.DrawTexture(new Rect(135 + 15, 800, 26, 28), kill); 
		//GUI.DrawTexture(new Rect(135 + 15 * 2, 800, 26, 28), kill); 
